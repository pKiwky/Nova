...
namespace Nova.Discord.Events {
    ...
    public class GuildMemberRemoved : IEvent<GuildMemberRemoveEventArgs> {
        public Task Run(DiscordClient client, GuildMemberRemoveEventArgs args) {
            ...
            foreach (var module in BaseModule.Modules) {
                ...
                module?.OnGuildMemberRemoved(novaGuild, client, args);
            }
