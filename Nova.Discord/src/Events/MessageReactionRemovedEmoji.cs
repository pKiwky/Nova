...
namespace Nova.Discord.Events {
    ...
    public class MessageReactionRemovedEmoji : IEvent<MessageReactionRemoveEmojiEventArgs> {
        public Task Run(DiscordClient client, MessageReactionRemoveEmojiEventArgs args) {
            ...
            foreach (var module in BaseModule.Modules) {
                ...
                module?.OnMessageReactionRemovedEmoji(novaGuild, client, args);
            }
