...
namespace Nova.Discord.Events {
    ...
    public class GuildBanRemoved: IEvent<GuildBanRemoveEventArgs> {
        public Task Run(DiscordClient client, GuildBanRemoveEventArgs args) {
            ...
            foreach (var module in BaseModule.Modules) {
                ...
                module?.OnGuildBanRemoved(novaGuild, client, args);
            }
