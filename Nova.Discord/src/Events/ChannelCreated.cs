...
namespace Nova.Discord.Events {
    ...
    public class ChannelCreated : IEvent<ChannelCreateEventArgs> {
        public Task Run(DiscordClient client, ChannelCreateEventArgs args) {
            ...
            foreach (var module in BaseModule.Modules) {
                ...
                module?.OnChannelCreated(novaGuild, client, args);
            }
