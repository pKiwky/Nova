...
namespace Nova.Discord.Events {
    ...
    public class MessageReactionsCleared : IEvent<MessageReactionsClearEventArgs> {
        public Task Run(DiscordClient client, MessageReactionsClearEventArgs args) {
            ...
            foreach (var module in BaseModule.Modules) {
                ...
                module?.OnMessageReactionsCleared(novaGuild, client, args);
            }
