...
namespace Nova.Discord.Events {
    ...
    public class ChannelDeleted : IEvent<ChannelDeleteEventArgs> {
        public Task Run(DiscordClient client, ChannelDeleteEventArgs args) {
            ...
            foreach (var module in BaseModule.Modules) {
                ...
                module?.OnChannelDeleted(novaGuild, client, args);
            }
