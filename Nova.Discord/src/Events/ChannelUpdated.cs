...
namespace Nova.Discord.Events {
    ...
    public class ChannelUpdated : IEvent<ChannelUpdateEventArgs> {
        public Task Run(DiscordClient client, ChannelUpdateEventArgs args) {
            ...
            foreach (var module in BaseModule.Modules) {
                ...
                module?.OnChannelUpdated(novaGuild, client, args);
            }
