...
namespace Nova.Discord.Events {
    ...
    public class GuildMembersChunked : IEvent<GuildMembersChunkEventArgs> {
        public Task Run(DiscordClient client, GuildMembersChunkEventArgs args) {
            ...
            foreach (var module in BaseModule.Modules) {
                ...
                module?.OnGuildMembersChunked(novaGuild, client, args);
            }
