...
namespace Nova.Discord.Events {
    ...
    public class GuildAvailable : IEvent<GuildCreateEventArgs> {
        public Task Run(DiscordClient client, GuildCreateEventArgs args) {
            ...
            foreach (var module in BaseModule.Modules) {
                ...
                module?.OnGuildAvailable(novaGuild, client, args);
            }
