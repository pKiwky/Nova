...
namespace Nova.Discord.Events {
    ...
    public class GuildMemberAdded : IEvent<GuildMemberAddEventArgs> {
        public Task Run(DiscordClient client, GuildMemberAddEventArgs args) {
            ...
            foreach (var module in BaseModule.Modules) {
                ...
                module?.OnGuildMemberAdded(novaGuild, client, args);
            }
