...
namespace Nova.Discord.Events {
    ...
    public class MessageUpdated : IEvent<MessageUpdateEventArgs> {
        public Task Run(DiscordClient client, MessageUpdateEventArgs args) {
            ...
            foreach (var module in BaseModule.Modules) {
                ...
                module?.OnMessageUpdated(novaGuild, client, args);
            }
